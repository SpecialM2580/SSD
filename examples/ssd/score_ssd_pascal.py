...
model_name = "VGG_"+datasetname+"_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/"+datasetname+"/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/"+datasetname+"/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/"+datasetname+"/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "results/"+datasetname+"/{}/Main".format(job_name)
...
# Stores LabelMapItem.
label_map_file = "data/"+datasetname+"/labelmap_voc.prototxt"
...
num_test_image = testimgnum
test_batch_size = testbatchnum
